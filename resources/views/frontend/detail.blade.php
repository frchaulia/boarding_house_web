        ...
        <div class="row mb-4">
          <div class="col-lg-6 mb-4">
            <img
              ...
              class="rounded w-100"
              src="{{ Storage::url($boarding->galleries()->latest()->first()->path) }}"
              alt=""
            />
          </div>
          <div class="col-lg-6">
            <div class="row">
                @foreach($boarding->galleries->take(4) as $gallery)
                    <div class="col-lg-6 mb-4">
                        <img
                        style="object-fit: cover"
        ...
        <div class="row">
          <div class="col-lg-8 mb-4">
            <div class="card border-0 p-4">
              ...
              <h4 class="mb-2">boarding Features</h4>
              <div class="d-grid grid-custom">
                  @foreach($boarding->features as $feature)
                        <div class="col w-100">
                        <div
                            class="d-flex align-items-center"
                            style="column-gap: 0.4rem"
            ...
            <div class="card py-5 h-100 border-0">
              <div class="mx-auto text-center">
                ...
                <ul class="list-unstyled mb-5">
                  ...
                  >
                    <span class="fw-light">Mobile : </span> {{ $boarding->owner->phone }}
                  </li>
                  <li
                    style="column-gap: 3rem"
                    class="text-secondary mb-3 d-flex justify-content-between"
                  >
                    <span class="fw-light">Fax : </span> {{ $boarding->owner->fax }}
                  </li>
                  <li
                    style="column-gap: 3rem"
                    class="text-secondary mb-3 d-flex justify-content-between"
                  >
                    <span class="fw-light">WhatsApp : </span> {{ $boarding->owner->whatsapp }}
                  </li>
                  <li
                    style="column-gap: 3rem"
                    class="text-secondary mb-3 d-flex justify-content-between"
                  >
                    <span class="fw-light">Email : </span> {{ $boarding->owner->email }}
                  </li>
                </ul>
              </div>
              <a href="tel:{{ $boarding->owner->phone }}" class="w-75 p-3 text-center mx-auto btn btn-primary"
                >Get boarding</a
              >
            </div>
          </div>
